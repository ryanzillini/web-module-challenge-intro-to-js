...
2. Use Math.computer to determine the computer's choice (Math.computer gives a computer number between 0 and 1)
3. Make a conditional that changes the variable to "rock", "paper", or "scissors" based on it's computer number
